...
export default function Home() {
  const [selectedTheoryCard, setSelectedTheoryCard] = useState<number | null>(
    null
  );
  ...
  const structuredData = {
    ...
    description:
      "AI-powered safety app that generates realistic emergency phone calls to help women escape dangerous situations",
          ...
          <div className="container relative z-10 mx-auto px-6 text-center max-[350px]:px-4 max-h-[350px]:px-4">
            ...
            >
              <motion.div
                ...
                className="hidden lg:flex flex justify-center mb-8"
              >
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-xs max-xs:w-[80dvw]">
                            <span className="text-wrap">
                              #1 QS World University Rankings in Education for
          ...
          >
            <div className="container mx-auto px-6">
              ...
              >
                <h2
                  id="problem-heading"
                  className="text-4xl md:text-6xl font-bold mb-6 text-gradient pb-2"
                >
                  The Shadow of Fear
                </h2>
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Before exploring solutions, it&apos;s crucial to grasp the
                  profound and widespread impact of Violence Against Women and
                  Girls (VAWG) in public spaces. This threat is not abstract; it
                  shapes daily lives, curtails freedom, and inflicts deep,
                  lasting harm.
                </p>
              </motion.div>
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-16 max-w-6xl mx-auto">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground leading-relaxed">
                        ...
                        <strong className="font-semibold">
                          50% of women in the UK
                        </strong>{" "}
                        feel unsafe walking alone after dark. Globally,
                        countless women intentionally change routines, avoid
                        public places, or limit participation in public life due
                        to fear of harassment or assault.
                      </p>
                    </CardContent>
                  </Card>
                </motion.div>
                ...
                >
                  <Card className="glass-effect hover-lift h-full text-center">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground leading-relaxed">
                        Experiencing or fearing VAWG leads to significant
                        psychological impacts, including increased{" "}
                        <strong className="font-semibold">
                          anxiety, depression, PTSD
                        </strong>
                        , and a persistent state of hypervigilance for millions
                        of women.
                      </p>
                    </CardContent>
                  </Card>
                ...
                >
                  <Card className="glass-effect hover-lift h-full text-center">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground leading-relaxed">
                        Gender-Based Violence, including VAWG in public spaces,
                        imposes enormous economic costs, estimated at{" "}
                        <strong className="font-semibold">
                          €366 billion annually in the EU alone
                        </strong>{" "}
                        through healthcare, justice system responses, and lost
                        productivity.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="glass-effect hover-lift h-full text-center">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground leading-relaxed">
                        Less than{" "}
                        <strong className="font-semibold">
                          10% of violence against women
                        </strong>{" "}
                        is reported to authorities, creating a massive gap in
                        safety response.
                      </p>
                    </CardContent>
                  </Card>
                ...
                >
                  <Card className="glass-effect hover-lift h-full text-center">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground leading-relaxed">
                        <strong className="font-semibold">
                          68-94% of women in developing countries
                        </strong>{" "}
                        report feeling safer with mobile phones, using them for
                        deterrence.
                      </p>
                    </CardContent>
                  </Card>
            ...
            <div className="container mx-auto px-6">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  ...
                  grounded in established criminological theories that explain
                  human behavior in threatening situations.
                </p>
              </motion.div>
          ...
          >
            <div className="container mx-auto px-6">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Users stories from women who need innovative safety solutions
          ...
          >
            <div className="container mx-auto px-6">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Transforming intuitive safety tactics into reliable,
                  intelligent technology requires careful balance of innovation
                  and ethics.
                </p>
              </motion.div>
          ...
          >
            <div className="container mx-auto px-6">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Though technology is useful in tackling violence against women
                  and girls, there are various other factors that need to be
                  considered in order to create a holistic approach to safety.
                </p>
              </motion.div>
            ...
            <div className="container mx-auto px-6 text-center">
              ...
              >
                <div className="flex justify-center items-center gap-3 mb-6">
                  <div className="hidden lg:flex relative animate-float mr-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Data from UN Women, WHO, national statistics offices, and
                  academic research • Built for innovators and changemakers
                </p>
            ...
            >
                  ...
                  {selectedTheoryCard !== null && (
                    <>
                      <div className="p-2 rounded-full bg-primary/10">
                        {React.createElement(
                          theoryCards[selectedTheoryCard].icon,
                          {
                      ...
                      <div>
                        <div className="text-xl font-bold">
                          {theoryCards[selectedTheoryCard]?.title}
                        </div>
                        <div className="text-sm text-primary font-medium">
                          {theoryCards[selectedTheoryCard]?.subtitle}
                        </div>
                      </div>
                    </>
                  )}
              ...
              {selectedTheoryCard !== null && (
                <div className="space-y-4">
                  <h4
                    id="theory-modal-description"
                    className="font-semibold text-lg text-primary"
                  >
                    Key Mechanisms:
                  </h4>
                  <ul className="space-y-3" role="list">
                    {theoryCards[selectedTheoryCard].details.map(
                      (detail, idx) => (
                        <li
                          key={idx}
